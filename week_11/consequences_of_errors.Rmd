...
Let's plot these with two plots that are overlaid upon each other. To do so, we'll first use the standard `plot` function, and then we'll use the `points` function which allows us to add points to a plot. 
