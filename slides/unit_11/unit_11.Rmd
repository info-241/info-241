...
- Treatment not delivered or not received
  - E.g. letters not read or emails not opened
...
- User activity often normalizes after adjusting to change
  - E.g. Change in purchase flow might cause **temporary** conversion increase
...
- Issues:
  ...
  - Unrealized manipulations, E.g. delay loading web page
...
- Really important to check covariate balance as a sanity check
...
- Tell story of why causal inference from observational data might be wrong
  - E.g. Playing outside improves children's eyesight
...
- E.g. Firm worries that holding back advertising for sake of experimenting will cost them money
...
### Administration, unfairness, giving up potential gains from treatment (e.g. ads)
...
- Parameters should look as expected
  - E.g. 80/20 treatment/control split
...
<!-- #################################################### -->
<!-- BELOW IS THE CODE THAT SHOULD DISPLAY FIGURES IN PDF -->
<!-- #################################################### -->
