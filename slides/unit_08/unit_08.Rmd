...
knitr::include_graphics(path = './figures/two_sided_zero.png')
```
...
```{r, echo = FALSE, fig.align='center', out.height=500, out.width=500} 
knitr::include_graphics(path = './figures/two_sided_one.png')
```
...
```{r, echo = FALSE, fig.align='center', out.height=500, out.width=500} 
knitr::include_graphics(path = './figures/two_sided_two.png')
```
...
knitr::include_graphics(path = './figures/table_3_1_a.png')
```
...
```{r, fig.height=3, fig.align='center', echo=FALSE}
knitr::include_graphics(path = './figures/table_3_1_b.png')
```
...
knitr::include_graphics(path = './figures/table_3_2.png')
```
...
```{r, echo = FALSE, fig.height=3, fig.align='center'}
knitr::include_graphics(path = './figures/figure_3_2.png')
```
