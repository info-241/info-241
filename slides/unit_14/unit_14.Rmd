...
- If ads weren't shown, would people searching "eBay" end up on eBay.com anyway?
  - Randomly assigned some regions to get ads while others didn't
  - If attribution model is correct, total sales should go down too
  - Observation alone predicts $1 spent yields $417.3 in revenue (4,173% ROI)
...
#### Treatment effect different from $Y$
#### Assumptions can exist without being aware of them
...
### Are there differences between the kind of people who get treatment and don't that we didn't (or can't) observe?
...
### See books by Karlan and Appel, Banerjee and Duflo
