...
subtitle: "Unit 5: Covariates and Regression"
...
- It **is** ossible to fix an experiment where you spread your observations to thin. 
...
- T-tests are often sufficient, but if covariates are correlated, t-tests could failt to reject *when they should*. 
