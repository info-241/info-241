...
To pull off the SEs from the Variance Covariance matrix, we need only to pull the square root of the diagonals of the VCOV. 
...
With each of these estimated, we can produce a table that reports all the estimates. 
