...
3.  Suppose that the sharp null hypothesis is true, thereby solving the
    *missing data* problem that is at the heart of the fundamental
...
Finally, generate a two sided p-value that makes a probabilistic statement about the proportion of treatment assignments that could have produced a treatment effect larger than the observed `ate`, even if the sharp null hypothesis were true. 
