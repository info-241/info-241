...
And, so, while the *science table* might contain information about each persons potential outcomes to treatment and control, the table of data that we're ever going to be able to generate has a more restricted set. Call this observable data set `obs`, and it is a subset of all the data that might be out there.
...
The mean of `y0` is `r round(mean_y0, 3)`, and the menace of control Y is `r round(mean_control_Y, 3)`. 
